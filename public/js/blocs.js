...
window.addEventListener("load", function() 
{
	...
	console.log('aaaaa')
	document.querySelector('.loading-view').classList.add('opacity-0');
	document.querySelector('.loading-view').classList.add('pointer-events-none');
	document.querySelector('.kv-title .vanishIn2').classList.add('vanishIn');
	document.querySelectorAll('.kv-title .fadeInDown2')[0].classList.add('fadeInDown');
	document.querySelectorAll('.kv-title .fadeInDown2')[1].classList.add('fadeInDown');
})
