...
+(function (a) {
  ...
  (a.fn.emulateTransitionEnd = function (b) {
    ...
    a(function () {
      (a.support.transition = c()),
        (a.support.csstransforms = d()),
        (a.support.csstransforms3d = e());
    });
  var f = "touch-carousel",
    g = function (b, c) {
      return (
        (this.$element = a(b)),
        (this.$itemsWrapper = this.$element.find(".carousel-inner_H")),
        (this.$items = this.$element.find(".item")),
        (this.$indicators = this.$element.find(".carousel-indicators")),
        (this.pane_width = this.pane_count = this.current_pane = 0),
        (this.onGesture = !1),
        (this.options = c),
        ...
        this.$items.length <= 1
          ...
          : (this._regTouchGestures(),
            void a(window).on(
              ...
              a.proxy(this._setPaneDimensions, this)
            ))
      );
    };
  (g.DEFAULTS = { interval: !1, toughness: 0.25 }),
    ...
    (g.prototype._regTouchGestures = function () {
      this.$itemsWrapper
        .add(this.$indicators)
        .hammer({ drag_lock_to_axis: !0, preventDefault: !0 })
        .on(
          "release dragleft dragright swipeleft swiperight",
          a.proxy(this._handleGestures, this)
        );
    }),
    ...
    (g.prototype._setContainerOffset = function (b, c, d) {
      ...
      if (
        ...
        c && this.$itemsWrapper.addClass("animate"),
        a.support.csstransforms3d)
      )
        (this.onGesture = !0),
          this.$itemsWrapper.css(
            "transform",
            "translate3d(" + b + "%,0,0) scale3d(1,1,1)"
          );
      else if (a.support.csstransforms)
        (this.onGesture = !0),
          this.$itemsWrapper.css("transform", "translate(" + b + "%,0)");
      else {
        var f = ((this.pane_width * this.pane_count) / 100) * b;
        this.$itemsWrapper.css("left", f + "px");
      }
      a.support.transition
        ? this.$itemsWrapper.one(a.support.transition.end, function () {
            e.$itemsWrapper.removeClass("animate"),
              (e.onGesture = !1),
              e._updateIndicators(d);
          })
        : (this.$itemsWrapper.removeClass("animate"),
          (this.onGesture = !1),
          this._updateIndicators(d));
    }),
    ...
    (g.prototype._handleGestures = function (a) {
      if (!this.sliding)
        switch ((this.pause(), a.type)) {
          case "dragright":
          case "dragleft":
            var b = -(100 / this.pane_count) * this.current_pane,
              c =
                ((100 / this.pane_width) * a.gesture.deltaX) / this.pane_count;
            ((0 === this.current_pane &&
              a.gesture.direction == Hammer.DIRECTION_RIGHT) ||
              (this.current_pane == this.pane_count - 1 &&
                a.gesture.direction == Hammer.DIRECTION_LEFT)) &&
              (c *= this.options.toughness),
          ...
          case "swiperight":
            ...
            break;
          case "release":
            Math.abs(a.gesture.deltaX) > this.pane_width / 2
              ? "right" == a.gesture.direction
                ? this.prev()
                : this.next()
    ...
    (g.prototype._updateIndicators = function (a) {
      return (
        this.$indicators.length &&
          ...
          this.$indicators.children().eq(a).addClass("active")),
  ...
  (a.fn.carousel = function (b) {
    return this.each(function () {
      ...
      d || c.data(f, (d = new g(this, e))).addClass(f),
        "number" == typeof b
          ? d.to(b)
          : h
          ? d[h]()
    ...
    (a.fn.carousel.Constructor = g),
    (a.fn.carousel.noConflict = function () {
      return (a.fn.carousel = h), this;
    }),
    a(document)
      .off("click.bs.carousel")
      .on(
        ...
        function (b) {
          ...
          h && (g.interval = !1),
            e.carousel(g),
            (h = d.attr("data-slide-to")) && e.data(f).to(h),
            b.preventDefault();
        }
      );
})(window.jQuery),
  (function (a, b) {
    ...
    (d.event = {
        ...
        matchType: function (a, b) {
          ...
          return (
            (c[d.POINTER_MOUSE] =
              ...
              b.pointerType == d.POINTER_MOUSE),
            (c[d.POINTER_TOUCH] =
              b.pointerType == b.MSPOINTER_TYPE_TOUCH ||
              b.pointerType == d.POINTER_TOUCH),
            (c[d.POINTER_PEN] =
              b.pointerType == b.MSPOINTER_TYPE_PEN ||
              b.pointerType == d.POINTER_PEN),
            c[a]
          );
        },
        getEvents: function () {
            ...
            for (var e = 0; e < d.length; e++)
              for (var f in b)
                b.hasOwnProperty(f) &&
                  ...
                  d[e] &&
                    (c =
                      d[e] + c.substring(0, 1).toUpperCase() + c.substring(1)),
                  (a.style[c] = b[f]));
            "none" == b.userSelect &&
          ...
          if (this.current && !this.stopped) {
            ...
            for (
              ...
              if (
                !this.stopped &&
                b[f.name] !== !1 &&
                f.handler.call(f, a, this.current.inst) === !1
              ) {
                this.stopDetect();
                break;
              }
              ...
              case d.EVENT_MOVE:
                ...
                if (
                  ...
                  (d.detection.current.startEvent.center.pageX += a.deltaX * c),
                    (d.detection.current.startEvent.center.pageY +=
                      a.deltaY * c),
      ...
      (d.gestures.Touch = {
        ...
        handler: function (a, b) {
          return b.options.prevent_mouseevents &&
            a.pointerType == d.POINTER_MOUSE
            ? void a.stopDetect()
  ...
  (function (a) {
    ...
    var b = function (b, c) {
      return c === a
        ? b
        : ((b.event.bindDom = function (b, d, e) {
            c(b).on(d, function (b) {
              var c = b.originalEvent || b;
              c.pageX === a && ((c.pageX = b.pageX), (c.pageY = b.pageY)),
                c.target || (c.target = b.target),
                c.which === a && (c.which = c.button),
                c.preventDefault || (c.preventDefault = b.preventDefault),
                c.stopPropagation || (c.stopPropagation = b.stopPropagation),
                e.call(this, c);
            });
          }),
          ...
          (c.fn.hammer = function (a) {
            return this.each(function () {
              var d = c(this),
                e = d.data("hammer");
              e
                ? e && a && b.utils.extend(e.options, a)
                : d.data("hammer", new b(this, a || {}));
            });
          }),
          b);
    };
    "function" == typeof define && "object" == typeof define.amd && define.amd
      ? define("hammer-jquery", ["hammer", "jquery"], b)
      : b(window.Hammer, window.jQuery || window.Zepto);
  })();
