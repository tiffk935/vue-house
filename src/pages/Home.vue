<template>
  ...
  <div v-bind:class="{
    ...
    <img class="w-32" src="@/assets/loading_w.gif" alt="美地莊園" srcset="">
  </div>
  <!--loading end-->
  <Nav v-if="config.showNav" />
  <div class="home bg-white overflow-hidden font-['Noto_Sans_TC']">
    <h1 style="display:none;">美地莊園</h1>
    <S1 />
    <S2 />
    <S3_S6 />
    <S7 />
...
import S3_S6 from "@/section/s3_s6.vue"
...
onMounted(() => {
  window.onload = function () {
    ...
    setTimeout(() => {
      let status = 0;
      let hideHand = false;
      document.querySelector('.s2 .map').scrollLeft = document.querySelector('.s2 .map .map1').clientWidth * 0.65 - window.innerWidth/2;
