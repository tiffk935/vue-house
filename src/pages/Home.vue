<template>
  ...
  <div v-bind:class="{
    ...
    <img class="w-32" src="@/assets/loading1.svg" alt="loading" srcset="">
  </div>
  <!--loading end-->
  <Nav v-if="config.showNav" />
  <div class="home bg-white text-[#000] overflow-hidden font-['Noto_Serif_TC']">
    <h1 style="display:none;">東泥大賦</h1>
    <S1 />
    <S2 />
    <S3 />
    <S4 />
