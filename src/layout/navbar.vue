<template>
    ...
    <div class="topnav">
        ...
        <div class="top-btns flex justify-between items-center">
            <a class="md:hidden" target="_blank" :href="info.googleLink"><img src="@/section/nav/map.svg" /></a>
            <img class="md:hidden" src="@/section/nav/phone.svg" @click="modalOpen = true; modalType = 'phone'" />
            <a class="md:hidden" target="_blank" :href="info.fbMessage"><img src="@/section/nav/msg.svg" /></a>
            ...
            <a class="hidden md:block" target="_blank" :href="info.googleLink">
                <svg class="block" width="38" height="50" viewBox="0 0 38 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="hidden md:block" target="_blank" :href="info.fbMessage">
                <svg class="block" width="43" height="50" viewBox="0 0 43 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="21" cy="19" r="18" fill="#005E4D" fill-opacity="0.8"/>
