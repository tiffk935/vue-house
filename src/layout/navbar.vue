<template>
    ...
    <div class="topnav">
        ...
        <div class="top-btns flex justify-between items-center">
            ...
            >
                <circle cx="21" cy="19" r="18" fill="#2277ab" fill-opacity="0.8"/>
...
.topnav {
    ...
    background: rgba(0, 77, 157, 0.5);
    border-bottom: size-m(1) solid #FFFFFF;
    z-index: 98;
    display: flex;
    ...
    @media screen and (min-width:768px) {
        ...
        border-bottom: size(1) solid #FFFFFF;
        font-size: size(17);
    }
