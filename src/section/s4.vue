<template>
  <section class="s4 relative">
    ...
    <div class="t1" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="0">生活裡想要的、需要的，剛剛好，都在這裡。</div>
    <div class="t2" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="200">河濱公園、濕地、遊艇碼頭…，依水而生，因水而美。北士科產業聚落、天母商圈、士林商圈、國際名校、優生醫療養護環境…，產業、交通、生活，心所想全部就位。</div>
    ...
    <ul class="t2 t3 z-10">
      ...
      <li data-aos="fade-up" data-aos-duration="1500" data-aos-delay="600"><span class="subtitle">交通快速便捷</span><span class="hr"></span><span class="desc">福國路、中山北路、洲美快速道路，條條大道暢行無阻。</span></li>
    </ul>
  </section>
</template>
