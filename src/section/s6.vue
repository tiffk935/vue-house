<template>
  <section class="s6 text-[#333333] bg-[#C4C3C0] relative">
    <div class="text" data-aos="fade-down" data-aos-delay="0">
      <div class="title-en">SCHOOL & HOSPITAL</div>
      <div class="title">優質文教</div>
      <div class="desc">學區齊全│東光國小、後甲國中、台南一中就近讀</div>
    ...
    <div class="slider">
      ...
      >
        <swiper-slide>
          <div class="img">
            <img class="photo w-full block" src="@/section/s6/1.jpg" />
            <div class="txt">成大醫院實景拍攝</div>
          </div>
        </swiper-slide>
        <swiper-slide>
          <div class="img">
            <img class="photo w-full block" src="@/section/s6/2.jpg" />
            <div class="txt">成功大學附設實景拍攝</div>
          </div>
        </swiper-slide>
        <swiper-slide>
          <div class="img">
            <img class="photo w-full block" src="@/section/s6/3.jpg" />
            <div class="txt">後甲國中實景拍攝</div>
          </div>
        </swiper-slide>
      </swiper>
    </div>
