  ...
  <div class="order relative text-center">
    <div class="order-inner">
      ...
      <div class="order-inner2">
        ...
        <!-- Title Image -->
        <!-- <img v-if="$isMobile()" class="order-title-img" src="@/section/form/titleImg_m.svg" alt="清景麟名人坊" srcset=""
          data-aos="fade" data-aos-duration="1000">
        <img v-else class="order-title-img" src="@/section/form/titleImg.svg" alt="清景麟名人坊" srcset="" data-aos="fade"
