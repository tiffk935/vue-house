      ...
      >
        <swiper-slide>
          <div class="relative">
            ...
            <div class="txt">五泰輕軌示意圖</div>
          </div>
        </swiper-slide>
        <swiper-slide>
          <div class="relative">
            <img src="@/section/s5/2.jpg" />
            <div class="txt">國道一號實景圖</div>
          </div>
        </swiper-slide>
        <swiper-slide>
          <div class="relative">
            <img src="@/section/s5/3.jpg" />
            <div class="txt">捷運蘆洲站實景圖</div>
          </div>
        </swiper-slide>
      </swiper>
...
@keyframes train {
  ...
  100% {
    transform: translateX(var(--trainX, 200%));
  }
}
...
.s5 {
  ...
  .cir1 {
    ...
    height: size-m(148);
    border-radius: 50%;
    background: linear-gradient(135deg, #6a1684 28.79%, #450957 85.35%);
