...
.contact-info {
  ...
  //   left: size(23);
  //   right: size(23);
  //   border: size(12) solid #006795;
  // }

  .logo {
    width: size(718);
    height: size(171);
    background-image: url("@/section/form/logo2.svg");
...
@media screen and (max-width:768px) {
  ...
  .contact-info {
    ...
    //   left: size-m(9);
    //   right: size-m(10);
    //   border: size-m(8) solid #006795;
    // }

    .logo {
      width: size-m(311.51);
      height: size-m(156.19);
      background-image: url("@/section/form/logo2-m.svg");
      margin-bottom: size-m(25.27);
    }
