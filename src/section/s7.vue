    ...
    <div class="md:flex md:justify-between md:items-start">
      ...
      <div class="slider user-n hidden md:block">
        ...
        <div class="slide-prev" @click="slidePrev2">
          <svg viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg"><circle cx="4" cy="4" r="4"/><path stroke="#FFF" fill="none" stroke-linecap="round" stroke-linejoin="round" d="M4.8,1.5L2.2,3.8l2.7,2.5"/></svg>
        </div>
        <div class="slide-next" @click="slideNext2">
          <svg viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg"><circle cx="4" cy="4" r="4"/><path stroke="#FFF" fill="none" stroke-linecap="round" stroke-linejoin="round" d="M3.2,6.5l2.7-2.3L3.2,1.7"/></svg>
        </div>
      </div>
    </div>
  </section>
